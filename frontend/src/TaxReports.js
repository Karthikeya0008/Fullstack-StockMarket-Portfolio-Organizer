...
export default function TaxReports() {
  ...
  const generateWordReport = (data) => {
    ...
    const projectName = "YieldWise Tax Computation Report 2024-25";
      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph(
              "1. This report has been auto-generated by the YieldWise Tax Computation Module based on the data provided by the user."
            ),
            new Paragraph(
            ...
            new Paragraph({
              children: [
                ...
                new TextRun({
                  text: "\nAuthorized by: YieldWise Automated System",
                  italics: true,
                }),
                new TextRun({
                  text: "\n\nThank you for trusting YieldWise with your portfolio management.",
                  bold: true,
                }),
              ],
              spacing: { before: 400 },
